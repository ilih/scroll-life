...
module.exports = function (customParams) {
  ...
  var ScrollLife = function () {
    function ScrollLife(params) {
      _classCallCheck(this, ScrollLife);

      this.initialClassName = params.initClass;
      this.btnParams = {
        upBtn: params.upBtn,
        downBtn: params.downBtn,
        btnHoverTimeout: params.btnHoverTimeout
      };
      this.liveClasses = {
        enableClass: params.enableClass,
        disableClass: params.disableClass
      };
  ...
  new ScrollLife(Object.assign({}, initialParams, customParams));
};
